...
public class ErrorService: IErrorService {
    ...
    public func setDelegate(_ delegate: ErrorServiceDelegate) {
        self.delegate = delegate
    }

    public func show(errorText: String) {
        show(message: errorText)
    }

    public func show(with title: String?, errorText: String, completion: @escaping (() -> Void)) {
